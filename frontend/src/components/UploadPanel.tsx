...
export function UploadPanel({ folder, onUploadComplete }: UploadPanelProps) {
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-muted-foreground">上传到: <span className="font-medium">{targetFolder}</span></p>
      </CardHeader>
