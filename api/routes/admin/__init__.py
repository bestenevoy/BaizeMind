...
- :mod:`api.routes.admin.llm_stats`     — LLM 调用 token 统计 (llm-stats/reset)
...
from api.routes.admin import cache_admin, graph_admin, llm_stats, search_debug, system
...
router.include_router(llm_stats.router)
