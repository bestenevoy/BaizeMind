    ...
    for f in files:
        try:
            ...
            summaries.append({
                ...
                "context_relevancy": data.get("summary", {}).get("context_relevancy", 0),
                "context_recall": data.get("summary", {}).get("context_recall", 0),
                "answer_relevancy": data.get("summary", {}).get("answer_relevancy", 0),
                "faithfulness": data.get("summary", {}).get("faithfulness", 0),
                "precision_at_5": data.get("summary", {}).get("precision_at_5"),
                "precision_at_10": data.get("summary", {}).get("precision_at_10"),
                "ndcg_at_5": data.get("summary", {}).get("ndcg_at_5"),
                "intrinsic_hallucination_rate": data.get("summary", {}).get("intrinsic_hallucination_rate", 0),
                "extrinsic_hallucination_rate": data.get("summary", {}).get("extrinsic_hallucination_rate", 0),
                "answer_completeness": data.get("summary", {}).get("answer_completeness", 0),
                "mrr": data.get("summary", {}).get("mrr"),
                "context_redundancy": data.get("summary", {}).get("context_redundancy", 0),
                "delta_ndcg": data.get("summary", {}).get("delta_ndcg"),
                "filter_drop_rate": data.get("summary", {}).get("filter_drop_rate", 0),
                "timing_mean_ms": data.get("summary", {}).get("timing_mean_ms", 0),
                "timing_p95_ms": data.get("summary", {}).get("timing_p95_ms", 0),
